    ...
    <div class="container">
      ...
      ?>
        ...
        <div class="social-links">
          ...
          ?>
            <a href="https://twitter.com/<?php echo $user_data['twitter']; ?>" class="twitter"><i class="bi bi-twitter"></i></a>
          <?php
          }
          ?>
          ...
          ?>
            <a href="https://facebook.com/<?php echo $user_data['facebook']; ?>" class="facebook"><i class="bi bi-facebook"></i></a>
          <?php
          }
          ?>
          ...
          ?>
            <a href="https://instagram.com/<?php echo $user_data['instagram']; ?>" class="instagram"><i class="bi bi-instagram"></i></a>
          <?php
          }
          ?>
          ...
          ?>
            <a href="https://www.linkedin.com/<?php echo $user_data['linkedin']; ?>" class="linkedin"><i class="bi bi-linkedin"></i></a>
          <?php
          }
          ?>
